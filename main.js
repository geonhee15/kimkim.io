...
const I18N = {
  ko: {
    ...
    'about.ambition': '지금은 학생이지만 진짜 회사로 만들고 싶은 게 있다. AI 에이전트, AR 글래스, 그리고 그 사이의 컴퓨팅 인터페이스. <em>MIT</em>에서 다음 단계로 가는 게 다음 목표.',
    'about.stats.label.since': 'BUILDING SINCE',
    'about.stats.value.since': '2019 (YouTube)',
  ...
  en: {
    ...
    'about.ambition': 'Currently a student, with one thing I want to turn into a real company — AI agents, AR glasses, and the computing interface between them. Next step: getting to <em>MIT</em> to build from there.',
    'about.stats.label.since': 'BUILDING SINCE',
    'about.stats.value.since': '2019 (YouTube)',
    'about.stats.label.based': 'BASED IN',
    'about.stats.value.based': 'Incheon, KR',
