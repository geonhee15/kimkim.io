...
const I18N = {
  ko: {
    ...
    'major.editing.tagline': '픽셀과 주파수, 둘 다 직접 자른다.',
    'major.editing.desc': '학교 공식 영상 + 키네틱 타이포그래피 팀 심사위원 + 글로벌 음MAD remix. Adobe·Blender·FL Studio·Reaper.',
    // Experiments header
    ...
    'beyond.recognition.mapMath': 'MAP 표준 시험 (NWEA) — 수학: 최근 3회 연속 99 백분위 (전국 상위 1%), 2학년 이후 93 백분위 아래로 떨어진 적 없음.',
    'beyond.recognition.mapEnglish': 'MAP 표준 시험 (NWEA) — 영어 (Language Usage): 최근 92 백분위 (상위 8%).',
    ...
    'card.typerace.desc': '타이핑 레이싱 게임. solo로 best 갱신하거나, 봇 3단계 (22/42/68 wpm)랑 1대1 레이싱. 로컬 계정 시스템 + WPM·정확도 추적.',
    ...
    'about.community': '학교에서는 학생 주도 마인크래프트 동아리를 친구와 함께 창립했고, 2-3학년 때는 친구들에게 큐브 튜토리얼을 1:1로 가르쳤다. \'잘하는 것\'에서 그치지 않고 가르치고 같이 만드는 게 자연스러웠다.',
  ...
  en: {
    ...
    'major.editing.tagline': 'Cutting pixels and frequencies — both by hand.',
    'major.editing.desc': 'School-commissioned videos + judging at a kinetic typography team + global otomad remixing. Adobe · Blender · FL Studio · Reaper.',
    'experiments.eyebrow': 'EXPERIMENTS & GAMES',
    ...
    'beyond.recognition.cty.sub': 'Quantitative · Highest identification level',
    'beyond.recognition.mapMath': 'MAP Standardized Test (NWEA) — Mathematics: 99th percentile for 3 consecutive testing windows (top 1% nationally), never below 93rd percentile since grade 2.',
    'beyond.recognition.mapEnglish': 'MAP Standardized Test (NWEA) — English (Language Usage): most recent 92nd percentile (top 8%).',
    ...
    'card.typerace.desc': 'Typing race game. Solo mode for personal bests, or 1-on-1 races against bots at 3 difficulty levels (22/42/68 wpm). Local account system + WPM/accuracy tracking.',
    ...
    'about.community': 'At school, I co-founded a student-led Minecraft club with a friend, and during grades 2-3 I mentored classmates one-on-one with cube tutorials. Sharing what I\'m good at — not just doing it — has always come naturally.',
    'about.stats.label.since': 'BUILDER WORK',
    'about.stats.value.since': 'Orion since 2026, ECHO incoming',
    'about.stats.label.operator': 'OPERATOR WORK',
    'about.stats.value.operator': 'YouTube channel since 2019 · 300K+',
